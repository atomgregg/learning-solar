<template>
  <v-app-bar color="cyan-darken-2">
      ...
      <v-app-bar-title>Software Innovation in the Bavarian Outback</v-app-bar-title>

      <v-btn to="/" exact>Home</v-btn>
      <v-btn to="/projects">Projects</v-btn>
      <v-btn to="/blogs">Blog</v-btn>
      ...
      <v-btn icon href="https://www.credly.com/users/aaron-gregg.d0145bdc/badges" target="_blank">
